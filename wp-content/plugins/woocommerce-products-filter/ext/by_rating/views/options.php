...
<li data-key="<?php echo $key ?>" class="woof_options_li">
    ...
    <strong style="display: inline-block; width: 176px;"><?php _e("By rating drop-down", 'woocommerce-products-filter'); ?>:</strong>
    <img class="help_tip" data-tip="<?php _e('Drop-down to filter ptoducts by rating', 'woocommerce-products-filter') ?>" src="<?php echo WP_PLUGIN_URL ?>/woocommerce/assets/images/help.png" height="16" width="16" />
