...
$SNP_THEMES_newtheme3_SIZES = array();
for ($i = 10; $i <= 72; $i++)
{
    $SNP_THEMES_newtheme3_SIZES[$i]	 = $i . 'px';
}
$SNP_THEMES['newtheme3']		 = array(
    'NAME'	 => 'New Theme 3',
    'STYLES' => 'css/newtheme3.css',
    'TYPES'	 => array(
	...
	array(
	    ...
	    'type'	 => 'color',
	    'std'	 => '#222222',
	    'desc'	 => __('(default: #222222)', 'nhp-opts'),
	...
	array(
	    ...
	    'type'	 => 'color',
	    'std'	 => '#FB0007',
	    'desc'	 => __('(default: #FB0007)', 'nhp-opts'),
	    'title'	 => __('Form Background Color', 'nhp-opts'),
	),
	array(
	    'id'	 => 'header',
	    'type'	 => 'text',
	...
	array(
	    ...
	    'args'	 => array(
		'sizes'		 => $SNP_THEMES_newtheme3_SIZES,
		'disable_fonts'	 => 1,
		'disable_color'	 => 1,
	    ),
	...
	array(
	    ...
	    'desc'	 => __('px (default: 16px, #ffffff)', 'nhp-opts'),
	    'args'	 => array(
		'sizes'		 => $SNP_THEMES_newtheme3_SIZES,
		'disable_fonts'	 => 1,
	    ),
	    'std'		 => array('size'	 => '16', 'color'	 => '#ffffff'),
	),
	array(
	    'id'	 => 'maintext',
	    'type'	 => 'textarea',
	...
	array(
	    ...
	    'desc'	 => __('px (default: 12px, #ffffff)', 'nhp-opts'),
	    'args'	 => array(
		'sizes'		 => $SNP_THEMES_newtheme3_SIZES,
		'disable_fonts'	 => 1,
	    ),
	    'std'		 => array('size'	 => '12', 'color'	 => '#ffffff'),
	),
	array(
	    'id'	 => 'name_placeholder',
	    'type'	 => 'text',
	...
	array(
	    'id'	 => 'submit_button_hover_text_color',
	    'type'	 => 'color',
	    'std'	 => '#ffffff',
	    'desc'	 => __('(default: #ffffff)', 'nhp-opts'),
	    'title'	 => __('Submit Button Text Color', 'nhp-opts'),
